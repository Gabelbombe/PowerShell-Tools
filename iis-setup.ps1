...
# --------------------------------------------------------------------
$InetPubRoot = "C:\intepub"
$InetPubLog = "C:\intepub\logs"
$InetPubWWWRoot = "C:\intepub\wwwroot"
...
# Installing IIS
# --------------------------------------------------------------------
Add-WindowsFeature -Name Web-Common-Http,Web-Asp-Net,Web-Net-Ext,Web-ISAPI-Ext,Web-ISAPI-Filter,Web-Http-Logging,Web-Request-Monitor,Web-Basic-Auth,Web-Windows-Auth,Web-Filtering,Web-Performance,Web-Mgmt-Console,Web-Mgmt-Compat,Web-Server,WAS -IncludeAllSubFeature
...
# --------------------------------------------------------------------
If (!(Test-Path "C:\intepub\temp\apppools")) {
  New-Item -Path "C:\intepub\temp\apppools" -type directory -Force -ErrorAction SilentlyContinue
}
